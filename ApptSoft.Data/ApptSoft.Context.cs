...
public partial class ApptSoftEntities : DbContext
{
    ...
    public virtual DbSet<FIBC_FabricDetails> FIBC_FabricDetails { get; set; }

    public virtual DbSet<FIBC_JobCard> FIBC_JobCard { get; set; }

    public virtual DbSet<FIBC_ComponentDetails> FIBC_ComponentDetails { get; set; }
